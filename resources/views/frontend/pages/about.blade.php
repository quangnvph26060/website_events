...
@section('content')
    ...
    "
        ...
        <div class="gdlr-core-pbf-background-wrap">
            <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js lazyloaded"
                data-bg="{{asset('frontend/assets/image/20200116-Event-Immica-scaled.jpg')}}"
                style="
          background-image: url('{{asset('frontend/assets/image/20200116-Event-Immica-scaled.jpg')}}');
                    ...
                    <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js">
                                ...
                                <ul>
                                    <li
                                        ...
                                        <span class="gdlr-core-icon-list-icon-wrap"><i
                                                ...
                                                style="color: #eba904; font-size: 20px"></i><i
                        ...
                        "></i></span>
                                        <div class="gdlr-core-icon-list-content-wrap">
                                            <span class="gdlr-core-icon-list-content" style="font-size: 20px">Corporate
                        ...
                        "></i></span>
                                        <div class="gdlr-core-icon-list-content-wrap">
                                            <span class="gdlr-core-icon-list-content" style="font-size: 20px">Brand or
                        ...
                        "></i></span>
                                        <div class="gdlr-core-icon-list-content-wrap">
                                            <span class="gdlr-core-icon-list-content" style="font-size: 20px">Client
                                                appreciation events</span>
                                        </div>
                                    </li>
                                    <li
                                        class="gdlr-core-skin-divider gdlr-core-with-hover gdlr-core-column-20 gdlr-core-column-first">
                        ...
                        "></i></span>
                                        <div class="gdlr-core-icon-list-content-wrap">
                                            <span class="gdlr-core-icon-list-content" style="font-size: 20px">Internal board
                        ...
                        "></i></span>
                                        <div class="gdlr-core-icon-list-content-wrap">
                                            <span class="gdlr-core-icon-list-content" style="font-size: 20px">Employee
                                                appreciation events</span>
                                        </div>
                                    </li>
                                    <li class="gdlr-core-skin-divider gdlr-core-with-hover gdlr-core-column-20">
                        ...
                        "></i></span>
                                        <div class="gdlr-core-icon-list-content-wrap">
                                            <span class="gdlr-core-icon-list-content" style="font-size: 20px">Business
                                                development events or trips</span>
                                        </div>
                                    </li>
                                    <li class="gdlr-core-skin-divider gdlr-core-with-hover gdlr-core-column-20">
                                        <span class="gdlr-core-icon-list-icon-wrap"><i
                        ...
                        "></i></span>
                                        <div class="gdlr-core-icon-list-content-wrap">
                                            <span class="gdlr-core-icon-list-content" style="font-size: 20px">Sales or
                                                hospitality trips (destination
                                                events)</span>
                                        </div>
                                    </li>
                                    <li class="gdlr-core-skin-divider gdlr-core-with-hover gdlr-core-column-20">
                        ...
                        "></i></span>
                                        <div class="gdlr-core-icon-list-content-wrap">
                                            <span class="gdlr-core-icon-list-content" style="font-size: 20px">Ceremonial
                                                events (grand opening, ground
                        ...
                        "></i></span>
                                        <div class="gdlr-core-icon-list-content-wrap">
                                            <span class="gdlr-core-icon-list-content" style="font-size: 20px">Global
                                                meeting or conference</span>
                                        </div>
                                    </li>
                                    <li class="gdlr-core-skin-divider gdlr-core-with-hover gdlr-core-column-20">
                                        <span class="gdlr-core-icon-list-icon-wrap"><i
                        ...
                        "></i></span>
                                        <div class="gdlr-core-icon-list-content-wrap">
                                            <span class="gdlr-core-icon-list-content" style="font-size: 20px">Staff or
                                                family festival events</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="gdlr-core-pbf-column gdlr-core-column-20 gdlr-core-column-first">
                    <div class="gdlr-core-pbf-column-content-margin gdlr-core-js" style="margin: 200px 0px 200px 0px">
                        ...
                        <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js">
                            <div class="gdlr-core-pbf-element">
                                <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix gdlr-core-left-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr"
                                    style="padding-bottom: 10px" id="gdlr-core-title-item-2">
                                    <div class="gdlr-core-title-item-title-wrap">
                                        <h3 class="gdlr-core-title-item-title gdlr-core-skin-title"
                                            style="
                        font-size: 40px;
            ...
            <div class="gdlr-core-pbf-column gdlr-core-column-60 gdlr-core-column-first">
                <div class="gdlr-core-pbf-column-content-margin gdlr-core-js" style="margin: 60px 0px 120px 0px">
                    <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js">
                        ...
                        "></i></span>
                                        <div class="gdlr-core-icon-list-content-wrap">
                                            <span class="gdlr-core-icon-list-content" style="font-size: 20px">Exhibitions,
                                                expositions, fairs
                                            </span>
                                        </div>
                                    </li>
                        ...
                        "></i></span>
                                        <div class="gdlr-core-icon-list-content-wrap">
                                            <span class="gdlr-core-icon-list-content"
                                                style="font-size: 20px">Festivals</span>
                                        </div>
                                    </li>
                                    <li
                                        class="gdlr-core-skin-divider gdlr-core-with-hover gdlr-core-column-30 gdlr-core-column-first">
                        ...
                        "></i></span>
                                        <div class="gdlr-core-icon-list-content-wrap">
                                            <span class="gdlr-core-icon-list-content"
                                                style="font-size: 20px">Cause-related events</span>
                                        </div>
                                    </li>
                                    <li
                                        class="gdlr-core-skin-divider gdlr-core-with-hover gdlr-core-column-30 gdlr-core-column-first">
                        ...
                        "></i></span>
                                        <div class="gdlr-core-icon-list-content-wrap">
                                            <span class="gdlr-core-icon-list-content" style="font-size: 20px">Fundraising
                                                events</span>
                                        </div>
                                    </li>
                                    <li class="gdlr-core-skin-divider gdlr-core-with-hover gdlr-core-column-30">
                ...
                <div class="gdlr-core-pbf-column gdlr-core-column-20 gdlr-core-column-first">
                    <div class="gdlr-core-pbf-column-content-margin gdlr-core-js" style="margin: 200px 0px 200px 0px">
                        ...
                        <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js">
                            <div class="gdlr-core-pbf-element">
                                <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix gdlr-core-left-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr"
                                    style="padding-bottom: 20px" id="gdlr-core-title-item-3">
                                    <div class="gdlr-core-title-item-title-wrap">
                                        <h3 class="gdlr-core-title-item-title gdlr-core-skin-title"
                                            style="
                        font-size: 40px;
            ...
            <div class="gdlr-core-pbf-column gdlr-core-column-60 gdlr-core-column-first">
                <div class="gdlr-core-pbf-column-content-margin gdlr-core-js" style="padding: 60px 0px 120px 0px">
                    <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js">
                        ...
                        "></i></span>
                                        <div class="gdlr-core-icon-list-content-wrap">
                                            <span class="gdlr-core-icon-list-content" style="font-size: 20px">Wedding
                                                Party</span>
                                        </div>
                                    </li>
                                    <li class="gdlr-core-skin-divider gdlr-core-with-hover gdlr-core-column-30">
                        ...
                        "></i></span>
                                        <div class="gdlr-core-icon-list-content-wrap">
                                            <span class="gdlr-core-icon-list-content" style="font-size: 20px">Birthday
                                                Party</span>
                                        </div>
                                    </li>
                                    <li
                        ...
                        "></i></span>
                                        <div class="gdlr-core-icon-list-content-wrap">
                                            <span class="gdlr-core-icon-list-content" style="font-size: 20px">Reunion
                                                Party</span>
                                        </div>
                                    </li>
                                    <li class="gdlr-core-skin-divider gdlr-core-with-hover gdlr-core-column-30">
                        ...
                        "></i></span>
                                        <div class="gdlr-core-icon-list-content-wrap">
                                            <span class="gdlr-core-icon-list-content" style="font-size: 20px">VIP
                                                Party</span>
                                        </div>
                                    </li>
                                    <li class="gdlr-core-skin-divider gdlr-core-with-hover gdlr-core-column-30">
                        ...
                        "></i></span>
                                        <div class="gdlr-core-icon-list-content-wrap">
                                            <span class="gdlr-core-icon-list-content" style="font-size: 20px">Family
                                                Party</span>
                                        </div>
                                    </li>
                                </ul>
    ...
    <div class="gdlr-core-pbf-wrapper" style="margin: 0px 0px 0px 0px" id="gdlr-core-wrapper-4">
        <div class="gdlr-core-pbf-background-wrap">
            <div class="lazyload gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js"
            ...
            <div class="gdlr-core-pbf-column gdlr-core-column-60 gdlr-core-column-first">
                <div class="gdlr-core-pbf-column-content-margin gdlr-core-js" style="padding: 60px 0px 120px 0px">
                    <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js">
                        ...
                        "></i></span>
                                        <div class="gdlr-core-icon-list-content-wrap">
                                            <span class="gdlr-core-icon-list-content" style="font-size: 20px">Exhibition
                                                booth design &amp;
                                                production</span>
                                        </div>
                                    </li>
                        ...
                        "></i></span>
                                        <div class="gdlr-core-icon-list-content-wrap">
                                            <span class="gdlr-core-icon-list-content" style="font-size: 20px">Art
                                                installation design &amp;
                                                production</span>
                                        </div>
                                    </li>
                        ...
                        "></i></span>
                                        <div class="gdlr-core-icon-list-content-wrap">
                                            <span class="gdlr-core-icon-list-content" style="font-size: 20px">Stage design
                                                &amp; production</span>
                                        </div>
                                    </li>
                                    <li class="gdlr-core-skin-divider gdlr-core-with-hover gdlr-core-column-30">
                        ...
                        "></i></span>
                                        <div class="gdlr-core-icon-list-content-wrap">
                                            <span class="gdlr-core-icon-list-content" style="font-size: 20px">Showroom
                                                design &amp; production</span>
                                        </div>
                                    </li>
                                </ul>
