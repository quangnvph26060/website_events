        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <img src="{{ showImage('') }}" class="img-fluid w-100" id="show_logo"
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <select name="is_active" id="is_active" class="form-select">
                                <option value="1" @checked(old('is_active', 1))>Hoạt động</option>
                                <option value="0" @checked(old('is_active', 0))>Ngưng hoạt động</option>
                            </select>
                            @error('is_active')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
