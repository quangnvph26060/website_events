...
(function (g, p, Q) {
  ...
  function ja(a, b) {
    a =
      "//ilightbox.net/getSource/jsonp.php?url=" +
  ...
  function R(a) {
    ...
    g("*", a).each(function () {
      var a = "";
      "none" != g(this).css("background-image")
        ? (a = g(this).css("background-image"))
        : "undefined" != typeof g(this).attr("src") &&
          "img" == this.nodeName.toLowerCase() &&
          (a = g(this).attr("src"));
  ...
  function da(a, b, c) {
    ...
    null == d && (d = r[b]);
    return null != d
      ? (0 == b.indexOf(a) && null == c && (c = b.substring(a.length)),
        null == c && (c = b),
        c + '="' + d + '" ')
      : "";
  }
  ...
  var T = {
      ...
      iframe:
        "asp aspx cgi cfm htm html jsp php pl php3 php4 php5 phtml rb rhtml shtml txt".split(
          " "
        ),
    ...
    z =
      !!("ontouchstart" in p) &&
      /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(V),
    oa =
    ...
    fa = function (a, b, c, d) {
      ...
      e.vars = {
        ...
        closeButton: g(
          '<a class="ilightbox-close" title="' + e.options.text.close + '"></a>'
        ),
        fullScreenButton: g(
          '<a class="ilightbox-fullscreen" title="' +
            e.options.text.enterFullscreen +
            '"></a>'
        ),
        innerPlayButton: g(
          '<a class="ilightbox-play" title="' +
            e.options.text.slideShow +
            '"></a>'
        ),
        innerNextButton: g(
          '<a class="ilightbox-next-button" title="' +
            e.options.text.next +
            '"></a>'
        ),
        innerPrevButton: g(
          '<a class="ilightbox-prev-button" title="' +
            e.options.text.previous +
            '"></a>'
        ),
        holder: g(
          '<div class="ilightbox-holder' +
            (z ? " supportTouch" : "") +
            '" ondragstart="return false;"><div class="ilightbox-container"></div></div>'
        ),
        nextPhoto: g(
          '<div class="ilightbox-holder' +
            (z ? " supportTouch" : "") +
            ' ilightbox-next" ondragstart="return false;"><div class="ilightbox-container"></div></div>'
        ),
        prevPhoto: g(
          '<div class="ilightbox-holder' +
            (z ? " supportTouch" : "") +
            ' ilightbox-prev" ondragstart="return false;"><div class="ilightbox-container"></div></div>'
        ),
        nextButton: g(
          '<a class="ilightbox-button ilightbox-next-button" ondragstart="return false;" title="' +
            e.options.text.next +
            '"><span></span></a>'
        ),
        prevButton: g(
          '<a class="ilightbox-button ilightbox-prev-button" ondragstart="return false;" title="' +
            e.options.text.previous +
            '"><span></span></a>'
        ),
        thumbnails: g(
      ...
      e.availPlugins();
      e.options.startFrom =
        0 < e.options.startFrom && e.options.startFrom >= e.vars.total
          ? e.vars.total - 1
          : e.options.startFrom;
      e.options.startFrom = e.options.randomStart
        ? M(S() * e.vars.total)
        : e.options.startFrom;
      ...
      e.options.controls.arrows &&
        g.extend(e.options.styles, {
          nextOffsetX: 0,
          prevOffsetX: 0,
          nextOpacity: 0,
          prevOpacity: 0,
  ...
  fa.prototype = {
    showLoader: function () {
      ...
      "horizontal" == this.options.path.toLowerCase()
        ? this.vars.loader
            .addClass("ilightbox-show")
            .stop()
            .animate({ top: "-30px" }, this.options.show.speed, "easeOutCirc")
        : this.vars.loader
            .addClass("ilightbox-show")
            .stop()
            .animate({ left: "-30px" }, this.options.show.speed, "easeOutCirc");
    },
    hideLoader: function () {
      --this.vars.loadRequests;
      this.vars.loadRequests =
        0 > this.vars.loadRequests ? 0 : this.vars.loadRequests;
      "horizontal" == this.options.path.toLowerCase()
        ? 0 >= this.vars.loadRequests &&
          this.vars.loader
            .removeClass("ilightbox-show")
            .stop()
            .animate({ top: "-192px" }, this.options.show.speed, "easeInCirc")
        : 0 >= this.vars.loadRequests &&
          this.vars.loader
            .removeClass("ilightbox-show")
            .stop()
            .animate({ left: "-192px" }, this.options.show.speed, "easeInCirc");
    },
    createUI: function () {
      var a = this;
      a.ui = {
    ...
    attachItems: function () {
      ...
      g(a.selector, a.context).each(function () {
        var d = g(this),
          ...
          f =
            (d.data("options") && eval("({" + d.data("options") + "})")) || {},
          h = d.data("caption"),
          l = d.data("title"),
          k = d.data("type") || aa(e);
    ...
    normalizeItems: function () {
      ...
      g.each(a.items, function (c, d) {
        ...
        f.social =
          "undefined" != typeof f.social
            ? f.social
            : a.options.social.buttons &&
              g.extend({}, {}, a.options.social.buttons);
        "video" == k &&
          ((f.html5video =
            "undefined" != typeof f.html5video ? f.html5video : {}),
          (f.html5video.webm = f.html5video.webm || f.html5video.WEBM || null),
          (f.html5video.controls =
            "undefined" != typeof f.html5video.controls
              ? f.html5video.controls
              : "controls"),
          (f.html5video.preload = f.html5video.preload || "metadata"),
          (f.html5video.autoplay =
            "undefined" != typeof f.html5video.autoplay
              ? f.html5video.autoplay
              : !1));
        (f.width && f.height) ||
          ("video" == k
            ...
            : "iframe" == k
            ? ((f.width = "100%"), (f.height = "90%"))
            : "flash" == k && ((f.width = 1280), (f.height = 720)));
        delete d.url;
        d.index = c;
        d.URL = e;
        d.caption = h;
    ...
    addContents: function () {
      var a = this,
        ...
        f =
          ...
          a.items.filter(function (a, b, d) {
            return (
              -1 === ["image", "flash", "video"].indexOf(a.type) &&
              "undefined" === typeof a.recognized &&
              (c.smartRecognition || a.options.smartRecognition)
            );
          }),
        h = 0 < f.length;
      c.mobileOptimizer &&
        !c.innerToolbar &&
        (b.isMobile = d.width <= b.mobileMaxWidth);
      ...
      c.controls.toolbar &&
        ...
        1 < b.total &&
          b.toolbar.append(b.innerPrevButton).append(b.innerNextButton));
      b.BODY.addClass("ilightbox-noscroll")
        .append(b.overlay)
        .append(b.loader)
        .append(b.holder)
        .append(b.nextPhoto)
      ...
      "horizontal" == e &&
        b.loader.add(b.nextButton).add(b.prevButton).addClass("horizontal");
      b.BODY[b.isMobile ? "addClass" : "removeClass"]("isMobile");
      c.infinite ||
        (b.prevButton
          .add(b.prevButton)
          .add(b.innerPrevButton)
          .add(b.innerNextButton)
          .removeClass("disabled"),
        0 == b.current &&
          b.prevButton.add(b.innerPrevButton).addClass("disabled"),
        b.current >= b.total - 1 &&
          b.nextButton.add(b.innerNextButton).addClass("disabled"));
      c.show.effect
        ? (b.overlay.stop().fadeIn(c.show.speed),
          b.toolbar.stop().fadeIn(c.show.speed))
        : (b.overlay.show(), b.toolbar.show());
      var l = f.length;
      h
        ? (a.showLoader(),
      ...
      c.slideshow.startPaused ||
        (a.resume(),
        b.innerPlayButton
          .removeClass("ilightbox-play")
          .addClass("ilightbox-pause"));
      "function" == typeof a.options.callback.onOpen &&
        a.options.callback.onOpen.call(a);
    },
    loadContent: function (a, b, c) {
      this.createUI();
      a.speed = c || this.options.effects.loadedFadeSpeed;
      "current" == b &&
        ((this.vars.lockWheel = a.options.mousewheel ? !1 : !0),
      ...
      if (a.title || this.options.innerToolbar) {
        ...
        this.options.innerToolbar &&
          f.append(
            1 < this.vars.total ? this.vars.toolbar.clone() : this.vars.toolbar
          );
        d.prepend(f);
      }
    ...
    loadSwitcher: function (a, b, c, d) {
      ...
      switch (a.type) {
        case "image":
          "function" == typeof f.callback.onBeforeLoad &&
            f.callback.onBeforeLoad.call(e, e.ui, c);
          "function" == typeof a.options.onBeforeLoad &&
            a.options.onBeforeLoad.call(e, h);
          e.loadImage(a.URL, function (k) {
            "function" == typeof f.callback.onAfterLoad &&
              f.callback.onAfterLoad.call(e, e.ui, c);
            "function" == typeof a.options.onAfterLoad &&
              a.options.onAfterLoad.call(e, h);
            b.data({
            ...
            g("div.ilightbox-container", b)
              ...
              .append(
                k
                  ? '<img src="' + a.URL + '" class="ilightbox-image" />'
                  : '<span class="ilightbox-alert">' +
                      f.errors.loadImage +
                      "</span>"
              );
            "function" == typeof f.callback.onRender &&
              f.callback.onRender.call(e, e.ui, c);
            "function" == typeof a.options.onRender &&
              a.options.onRender.call(e, h);
          ...
          g.ajax({
            ...
            success: function (k, l, n) {
              ...
              var q = g(k),
                ...
                C =
                  e.items[c].options.width ||
                  parseInt(q[0].getAttribute("width")),
                v =
                  e.items[c].options.height ||
                  parseInt(q[0].getAttribute("height")),
                y =
                  q[0].getAttribute("width") && q[0].getAttribute("height")
                    ? { overflow: "hidden" }
                    : {};
              u.empty().append(
                g('<div class="ilightbox-wrapper"></div>').css(y).html(q)
              );
              b.show()
                .data({
        ...
        case "html":
          ...
          k[0].nodeName
            ? (l = k.clone())
            : ((k = g(k)), (l = k.selector ? g("<div>" + k + "</div>") : k));
    ...
    configureHolder: function (a, b, c) {
      ...
      "current" != b &&
        ("next" == b
          ? c.addClass("ilightbox-next")
          : c.addClass("ilightbox-prev"));
          ...
          ? c.css(B, H).fadeIn(a.speed, function () {
              ...
              if ((b = a.options.social))
                d.setSocial(b, a.URL, c),
                  f.social.start &&
                    g("div.ilightbox-social", c).fadeIn(f.effects.fadeSpeed);
              d.generateThumbnails();
              "function" == typeof f.callback.onShow &&
                f.callback.onShow.call(d, d.ui, h);
              "function" == typeof a.options.onShow &&
                a.options.onShow.call(d, k);
            })
          : (c.show(),
            d.generateThumbnails(),
            "function" == typeof f.callback.onShow &&
    ...
    generateBoxes: function () {
      var a = this.vars,
        b = this.options;
      b.infinite && 3 <= a.total
        ? (a.current == a.total - 1 && (a.next = 0),
          0 == a.current && (a.prev = a.total - 1))
        : (b.infinite = !1);
      this.loadContent(this.items[a.current], "current", b.show.speed);
      this.items[a.next] &&
        this.loadContent(this.items[a.next], "next", b.show.speed);
      this.items[a.prev] &&
        this.loadContent(this.items[a.prev], "prev", b.show.speed);
    },
      ...
      if (b.thumbs && !a.vars.dontGenerateThumbs) {
        ...
        g.each(a.items, function (k, n) {
          var m = b.current == k ? "ilightbox-active" : "",
            C =
              b.current == k
                ? c.thumbnails.activeOpacity
                : c.thumbnails.normalOpacity,
            y = n.options.thumbnail,
            q = g('<div class="ilightbox-thumbnail"></div>'),
            u = g('<div class="ilightbox-thumbnail-icon"></div>');
          q.css({ opacity: 0 }).addClass(m);
          ("video" != n.type && "flash" != n.type) ||
          "undefined" != typeof n.options.icon
            ? n.options.icon &&
              (u.addClass("ilightbox-thumbnail-" + n.options.icon), q.append(u))
          ...
          y &&
            a.loadImage(y, function (b) {
              ...
              b
                ? q
                    .data({ naturalWidth: b.width, naturalHeight: b.height })
                    .append('<img src="' + y + '" border="0" />')
                : q.data({
    ...
    positionThumbnails: function (a, b, c) {
      ...
      e =
        "horizontal" == l
          ? h.width - f.styles.pageOffsetX
          : k.eq(0).outerWidth() - f.styles.pageOffsetX;
      h =
        "horizontal" == l
          ? k.eq(0).outerHeight() - f.styles.pageOffsetY
          : h.height - f.styles.pageOffsetY;
      var n = "horizontal" == l ? 0 : e,
        m = "horizontal" == l ? h : 0,
        C = g(".ilightbox-active", c),
        y = {};
      3 > arguments.length &&
        (k.css({ opacity: f.thumbnails.normalOpacity }),
        C.css({ opacity: f.thumbnails.activeOpacity }));
      k.each(function (a) {
        a = g(this);
        var b = a.data(),
          c = "horizontal" == l ? 0 : f.thumbnails.maxWidth;
        height = "horizontal" == l ? f.thumbnails.maxHeight : 0;
        dims = d.getNewDimenstions(
          c,
          height,
          b.naturalWidth,
          b.naturalHeight,
      ...
      var q = C.length
        ? C.offset()
        : { top: parseInt(h / 2), left: parseInt(e / 2) };
      k.top -= E.scrollTop();
      k.left -= E.scrollLeft();
      ...
      "horizontal" == l
        ? ((y.top = 0),
          (y.left = parseInt(e / 2 - q.left - C.outerWidth() / 2)))
        : ((y.top = parseInt(h / 2 - q.top - C.outerHeight() / 2)),
          (y.left = 0));
      3 > arguments.length
        ? c.stop().animate(y, f.effects.repositionSpeed, "easeOutCirc")
        : c.css(y);
    },
    ...
    patchEvents: function () {
      ...
      var b = this,
        ...
        k = [
          c.nextButton[0],
          c.prevButton[0],
          c.nextButton[0].firstChild,
          c.prevButton[0].firstChild,
        ];
      O.bind("resize.iLightBox", function () {
        var a = J();
        d.mobileOptimizer &&
          !d.innerToolbar &&
          (c.isMobile = a.width <= c.mobileMaxWidth);
      ...
      h = [
        d.caption.show + ".iLightBox",
        d.caption.hide + ".iLightBox",
        d.social.show + ".iLightBox",
        d.social.hide + ".iLightBox",
      ...
      E.on(K, ".ilightbox-overlay", function () {
        ...
        .on(
          n,
          ".ilightbox-holder:not(.ilightbox-next, .ilightbox-prev)",
          function (a) {
            var b = g("div.ilightbox-caption", c.holder),
              e = g("div.ilightbox-social", c.holder),
              f = d.effects.fadeSpeed;
            c.nextLock || c.prevLock
              ? (a.type != d.caption.show || b.is(":visible")
                  ? a.type == d.caption.hide && b.is(":visible") && b.fadeOut(f)
                  : b.fadeIn(f),
                a.type != d.social.show || e.is(":visible")
                  ? a.type == d.social.hide && e.is(":visible") && e.fadeOut(f)
                  : e.fadeIn(f))
              : (a.type != d.caption.show || b.is(":visible")
                  ? a.type == d.caption.hide &&
                    b.is(":visible") &&
                    b.stop().fadeOut(f)
                  : b.stop().fadeIn(f),
                a.type != d.social.show || e.is(":visible")
                  ? a.type == d.social.hide &&
                    e.is(":visible") &&
                    e.stop().fadeOut(f)
                  : e.stop().fadeIn(f));
          }
        ...
        .on(
          "mouseenter.iLightBox mouseleave.iLightBox",
          ".ilightbox-wrapper",
          function (a) {
        ...
        .on(
          K,
          ".ilightbox-toolbar a.ilightbox-close, .ilightbox-toolbar a.ilightbox-fullscreen, .ilightbox-toolbar a.ilightbox-play, .ilightbox-toolbar a.ilightbox-pause",
          function () {
            var a = g(this);
            a.hasClass("ilightbox-fullscreen")
              ...
              ? (b.resume(),
                a.addClass("ilightbox-pause").removeClass("ilightbox-play"))
              : a.hasClass("ilightbox-pause")
              ? (b.pause(),
                a.addClass("ilightbox-play").removeClass("ilightbox-pause"))
              : b.closeAction();
          }
        )
        .on(
          W,
          ".ilightbox-overlay, .ilightbox-thumbnails-container",
          function (a) {
            a.preventDefault();
          }
        );
      ...
      if (d.controls.slideshow && d.slideshow.pauseOnHover)
        E.on(
          ...
          ".ilightbox-holder:not(.ilightbox-next, .ilightbox-prev)",
          function (a) {
            "mouseenter" == a.type && c.cycleID
              ? b.pause()
              : "mouseleave" == a.type && c.isPaused && b.resume();
          }
        );
      ...
      if (d.controls.swipe)
        f.on(pa, function (a) {
          function h(a) {
            ...
            b[0].style["horizontal" == e ? "left" : "top"] =
              ("horizontal" == e ? a.left - c[0] : a.top - c[1]) + "px";
          }
          function k(a) {
            if (w) {
          ...
          if (!(c.nextLock || c.prevLock || 1 == c.total || c.lockSwipe)) {
            ...
            E.one(qa, function (a) {
              ...
              w &&
                ...
                ("horizontal" == e &&
                1e3 > x.time - w.time &&
                I(w.coords[0] - x.coords[0]) > l &&
                I(w.coords[1] - x.coords[1]) < verticalDistanceThreshold
                  ...
                  : "vertical" == e &&
                    1e3 > x.time - w.time &&
                    I(w.coords[1] - x.coords[1]) > l &&
                    I(w.coords[0] - x.coords[0]) < verticalDistanceThreshold
    ...
    goTo: function (a) {
      ...
      if (1 == e) b.moveTo("next");
        ...
        g(".ilightbox-thumbnail", c.thumbnails)
          .removeClass("ilightbox-active")
          .eq(a)
          .addClass("ilightbox-active");
        ...
        d.infinite ||
          (c.nextButton
            .add(c.prevButton)
            .add(c.innerPrevButton)
            .add(c.innerNextButton)
            .removeClass("disabled"),
          0 == c.current &&
            c.prevButton.add(c.innerPrevButton).addClass("disabled"),
          c.current >= c.total - 1 &&
            c.nextButton.add(c.innerNextButton).addClass("disabled"));
        b.resetCycle();
        "function" == typeof d.callback.onAfterChange &&
          d.callback.onAfterChange.call(b, b.ui);
      }
    },
    moveTo: function (a) {
      var b = this,
      ...
      if ((q = b.items[l].options.social))
        b.setSocial(q, b.items[l].URL, k),
          d.social.start &&
            g("div.ilightbox-social", k).fadeIn(d.effects.fadeSpeed);
      ...
      k.css(B, H).animate(
        { top: w, left: v, opacity: 1 },
        h,
        c.isSwipe ? "easeOutCirc" : "easeInOutCirc",
        function () {
          k.css(B, "");
        }
      );
      ...
      w =
        "horizontal" == e
          ? parseInt(f / 2 - x.offsetY - r / 2 - v.H - t.H / 2)
          : parseInt(f - x.offsetX - v.H - t.H / 2);
      "prev" == a
        ? (v =
            "horizontal" == e
              ? parseInt(q - x.offsetX - v.W - t.W / 2)
              : parseInt(q / 2 - u / 2 - v.W - x.offsetY - t.W / 2))
        : ((w =
            "horizontal" == e ? w : parseInt(x.offsetX - v.H - r - t.H / 2)),
          (v =
            "horizontal" == e
              ? parseInt(x.offsetX - v.W - u - t.W / 2)
              : parseInt(q / 2 - x.offsetY - u / 2 - v.W - t.W / 2)));
      ...
      n.addClass(C)
        .css(B, H)
        .animate(
          { top: w, left: v, opacity: d.styles.prevOpacity },
          h,
          c.isSwipe ? "easeOutCirc" : "easeInOutCirc",
          function () {
            n.css(B, "");
            ...
            b.positionThumbnails();
            b.items[l] &&
              ((c.lockWheel = b.items[l].options.mousewheel ? !1 : !0),
              (c.lockSwipe = b.items[l].options.swipe ? !1 : !0));
            c.isSwipe = !1;
            -1 !== ["iframe", "video"].indexOf(b.items[c.current].type) &&
              g("div.ilightbox-container", n).empty();
            "next" == a
              ? ((c.nextPhoto = m),
                (c.prevPhoto = n),
                (c.holder = k),
                ...
                (c.current += 1),
                d.infinite &&
                  (c.current > c.total - 1 && (c.current = 0),
                  c.current == c.total - 1 && (c.next = 0),
                  0 == c.current && (c.prev = c.total - 1)),
                b.createUI(),
                b.items[c.next]
                  ? b.loadContent(b.items[c.next], "next")
                  : (c.nextLock = !1))
              : ((c.prevPhoto = m),
                (c.nextPhoto = n),
                (c.holder = k),
                ...
                b.createUI(),
                b.items[c.prev]
                  ? b.loadContent(b.items[c.prev], "prev")
                  : (c.prevLock = !1));
            -1 !== ["iframe", "video"].indexOf(b.items[c.current].type) &&
              b.loadContent(b.items[c.current], "current");
            d.linkId &&
              setTimeout(function () {
                c.hashLock = !1;
              }, 55);
      ...
      w =
        "horizontal" == e
          ? F(m, "top")
          : "next" == a
          ? parseInt(-(f / 2) - m.outerHeight())
          : parseInt(2 * w);
      v =
        "horizontal" == e
          ? "next" == a
            ? parseInt(-(q / 2) - m.outerWidth())
            : parseInt(2 * v)
          : F(m, "left");
      m.css(B, H)
        .animate(
          { top: w, left: v, opacity: d.styles.nextOpacity },
          h,
          c.isSwipe ? "easeOutCirc" : "easeInOutCirc",
          function () {
            m.css(B, "");
    ...
    setCaption: function (a, b) {
      ...
      a.caption &&
        (c.html(a.caption), g("div.ilightbox-container", b).append(c));
    },
    normalizeSocial: function (a, b) {
      ...
      g.each(a, function (e, f) {
        ...
        a[e] = {
          ...
          width:
            "undefined" == typeof f.width || isNaN(f.width)
              ? 640
              : parseInt(f.width),
          height: f.height || 360,
        };
    ...
    fullScreenAction: function () {
      t.supportsFullScreen
        ? t.isFullScreen()
          ? t.cancelFullScreen(document.documentElement)
          : t.requestFullScreen(document.documentElement)
        : this.doFullscreen();
    },
      ...
      if (c.fullAlone) {
        ...
        if (a.isInFullScreen)
          (a.isInFullScreen = a.lockKey = a.lockWheel = a.lockSwipe = !1),
            ...
            "function" == typeof c.callback.onExitFullScreen &&
              c.callback.onExitFullScreen.call(this, this.ui);
        else {
          ...
          if (-1 != c.fullStretchTypes.indexOf(e.type))
            ...
            "fill" == b.toLowerCase()
              ...
              : "fit" == b.toLowerCase()
              ? ((h = this.getNewDimenstions(a, e, f, k, !0)),
                (a = h.width),
                (e = h.height))
          ...
          "function" == typeof c.callback.onEnterFullScreen &&
            c.callback.onEnterFullScreen.call(this, this.ui);
        }
    ...
    closeAction: function () {
      ...
      g(".ilightbox-overlay, .ilightbox-holder, .ilightbox-thumbnails").off(
        ".iLightBox"
      );
      b.hide.effect
      ...
      "function" == typeof b.callback.onHide &&
        b.callback.onHide.call(this, this.ui);
    },
    repositionPhoto: function () {
      var a = this.vars,
        ...
        f = d.height;
      d =
        (a.isInFullScreen && b.fullAlone) || a.isMobile
          ? 0
          : "horizontal" == c
          ? 0
          : a.thumbnails.outerWidth();
      var h = a.isMobile
        ? a.toolbar.outerHeight()
        : a.isInFullScreen && b.fullAlone
        ? 0
        : "horizontal" == c
        ? a.thumbnails.outerHeight()
        : 0;
      ...
      var l =
          "horizontal" == c
            ? parseInt(
                this.items[a.next] || this.items[a.prev]
                  ? 2 * (b.styles.nextOffsetX + b.styles.prevOffsetX)
                  : 30 >= e / 10
                  ? 30
                  : e / 10
              )
            : parseInt(30 >= e / 10 ? 30 : e / 10) + d,
        k =
          "horizontal" == c
            ? parseInt(30 >= f / 10 ? 30 : f / 10) + h
            : parseInt(
                this.items[a.next] || this.items[a.prev]
                  ? 2 * (b.styles.nextOffsetX + b.styles.prevOffsetX)
                  : 30 >= f / 10
    ...
    repositionEl: function (a) {
      ...
      "current" == a.type
        ? ("number" == typeof l.width &&
            ...
            (e =
              b.isInFullScreen &&
              c.fullAlone &&
              (-1 != c.fullStretchTypes.indexOf(h.type) ||
                l.fullViewPort ||
                c.fullViewPort)
                ? e
                : l.width > e
        ...
        : ("number" == typeof l.width &&
          ...
          "number" == typeof l.height &&
            l.height &&
            (f = l.height > f ? f : l.height));
      c.innerToolbar &&
        (f = parseInt(f - g(".ilightbox-inner-toolbar", k).outerHeight()));
      b =
        "string" == typeof l.width && -1 != l.width.indexOf("%")
          ? ba(parseInt(l.width.replace("%", "")), a.width)
          : k.data("naturalWidth");
      h =
        "string" == typeof l.height && -1 != l.height.indexOf("%")
          ? ba(parseInt(l.height.replace("%", "")), a.height)
          : k.data("naturalHeight");
      h =
        ("string" == typeof l.width && -1 != l.width.indexOf("%")) ||
        ("string" == typeof l.height && -1 != l.height.indexOf("%"))
          ? { width: b, height: h }
      ...
      "prev" == a.type || "next" == a.type
        ? ((b = parseInt(
            h.width *
              ("next" == a.type ? c.styles.nextScale : c.styles.prevScale)
          )),
          (h = parseInt(
            h.height *
              ("next" == a.type ? c.styles.nextScale : c.styles.prevScale)
      ...
      f = parseInt(
        (F(k, "padding-left") +
          F(k, "padding-right") +
          F(k, "border-left-width") +
          F(k, "border-right-width")) /
          2
      );
      l = parseInt(
        (F(k, "padding-top") +
          F(k, "padding-bottom") +
          F(k, "border-top-width") +
          F(k, "border-bottom-width") +
          (g(".ilightbox-inner-toolbar", k).outerHeight() || 0)) /
          2
      );
      switch (a.type) {
        case "current":
        ...
        case "next":
          q =
            "horizontal" == d
              ? parseInt(a.height / 2 - m - h / 2 - l - r / 2)
              : parseInt(a.height - n - l - r / 2);
          u =
            "horizontal" == d
              ? parseInt(a.width - n - f - p / 2)
              : parseInt(a.width / 2 - b / 2 - f - m - p / 2);
          break;
        case "prev":
          (q =
            "horizontal" == d
            ...
            (u =
              "horizontal" == d
                ? parseInt(n - f - b - p / 2)
                : parseInt(a.width / 2 - m - b / 2 - f - p / 2));
      }
      k.data("offset", {
        top: q,
        left: u,
      ...
      0 < a.animate && c.effects.reposition
        ? (k
            ...
            .animate(
              { top: q, left: u },
              c.effects.repositionSpeed,
              "easeOutCirc",
              function () {
                k.css(B, "");
              }
            ),
          g("div.ilightbox-container", k)
            .stop()
            .animate(
              { width: b, height: h },
              c.effects.repositionSpeed,
        ...
        : (k.css({ top: q, left: u }),
          g("div.ilightbox-container", k).css({ width: b, height: h }),
          g("div.ilightbox-inner-toolbar", k).css({ width: b }));
    },
    resume: function (a) {
      var b = this,
        c = b.vars,
    ...
    resetCycle: function () {
      var a = this.vars;
      this.options.controls.slideshow &&
        a.cycleID &&
        !a.isPaused &&
        this.resume();
    },
    getNewDimenstions: function (a, b, c, d, e) {
      ...
      e ||
        (factor > this.options.maxScale
          ? (factor = this.options.maxScale)
          : factor < this.options.minScale && (factor = this.options.minScale));
    ...
    availPlugins: function () {
      ...
      this.plugins = {
        ...
        html5H264: !(
          !a.canPlayType || !a.canPlayType("video/mp4").replace(/no/, "")
        ),
        html5WebM: !(
          !a.canPlayType || !a.canPlayType("video/webm").replace(/no/, "")
        ),
        html5Vorbis: !(
          !a.canPlayType || !a.canPlayType("video/ogg").replace(/no/, "")
        ),
        html5QuickTime: !(
    ...
    addContent: function (a, b) {
      switch (b.type) {
        case "video":
          ...
          ("video/mp4" == d || "mp4" == b.ext || "m4v" == b.ext || e.h264) &&
          this.plugins.html5H264
            ? ((b.ext = "mp4"), (b.URL = e.h264 || b.URL))
            : e.webm && this.plugins.html5WebM
            ? ((b.ext = "webm"), (b.URL = e.webm || b.URL))
            : e.ogg &&
              this.plugins.html5Vorbis &&
              ((b.ext = "ogv"), (b.URL = e.ogg || b.URL));
          !this.plugins.html5H264 ||
          ("video/mp4" != d && "mp4" != b.ext && "m4v" != b.ext)
            ? !this.plugins.html5WebM || ("video/webm" != d && "webm" != b.ext)
              ? !this.plugins.html5Vorbis ||
                ("video/ogg" != d && "ogv" != b.ext)
                ? !this.plugins.html5QuickTime ||
                  ("video/quicktime" != d && "mov" != b.ext && "qt" != b.ext) ||
                  ((c = !0), (d = "video/quicktime"))
                : ((c = !0), (d = "video/ogg"))
              : ((c = !0), (d = "video/webm"))
            : ((c = !0), (d = "video/mp4"));
          if (c)
            var f = g("<video />", {
              ...
              poster: e.poster,
              controls: e.controls,
            }).append(g("<source />", { src: b.URL, type: d }));
          else
          ...
          if (this.plugins.flash) {
            ...
            f = g("<embed />").attr({
              ...
              width:
                ...
                b.options.width &&
                "1" == this.options.minScale &&
                "1" == this.options.maxScale
                  ? b.options.width
                  : "100%",
              height:
            ...
            f = g("<span />", {
              class: "ilightbox-alert",
              html: this.options.errors.missingPlugin
                .replace("{pluginspage}", "http://www.adobe.com/go/getflash")
                .replace("{type}", "Adobe Flash player"),
            });
          break;
        case "iframe":
          f = g("<iframe />").attr({
          ...
          break;
        case "inline":
          f = g('<div class="ilightbox-wrapper"></div>').html(
            g(b.URL).clone(!0)
          );
          break;
        case "html":
    ...
    hashChangeHandler: function (a) {
      ...
      b.hashLock ||
        ...
        (d[1]
          ? ((b = d[1] || 0),
            this.items[b]
              ? ((a = g(".ilightbox-overlay")),
                a.length && a.attr("linkid") == c.linkId
                  ? this.goTo(b)
                  : this.itemsObject[b].trigger(z ? "itap" : "click"))
    ...
    b = g.extend(
      !0,
      {
        ...
        errors: {
          ...
          missingPlugin:
            "The content your are attempting to view requires the <a href='{pluginspage}' target='_blank'>{type} plugin</a>.",
        },
        ajaxSetup: {
          url: "",
        ...
        b.bind("touchstart.iTap", function (e) {
          ...
          b.one("touchend.iTap", function (b) {
            ...
            c &&
              ...
              c.x == d.x &&
              c.y == d.y &&
              (g.event.dispatch || g.event.handle).call(a, b);
            c = d = Q;
          });
        });
      },
  ...
  var ha = {
    ...
    splitNumRegx: /[\.\_,-]/g,
    getNum: function (a, b) {
      var c = this.isStrNum(a)
        ? (this.isDefined(b) ? new RegExp(b) : this.getNumRegx).exec(a)
        : null;
      return c ? c[0] : null;
    },
        ...
        if (!a.isIE && b) {
          ...
          for (d = 0; d < e.length; d++)
            if (
              a.isString(e[d]) &&
              /[^\s]/.test(e[d]) &&
              (c = (b = navigator.mimeTypes[e[d]]) ? b.enabledPlugin : 0) &&
    ...
    findNavPlugin: function (a, b, c) {
      ...
      for (e = 0; e < d.length; e++) {
        ...
        if (
          (a.test(f) &&
            (!b || b.test(RegExp.leftContext + RegExp.rightContext))) ||
          (a.test(h) &&
            (!b || b.test(RegExp.leftContext + RegExp.rightContext)))
        )
    ...
    initScript: function () {
      ...
      for (b in this.Plugins)
        this.Plugins[b] &&
          this.initObj(this.Plugins[b], ["$", this, "$$", this.Plugins[b]], 1);
      ...
      this.head =
        ...
        null;
      this.verIE =
        (this.isIE = new Function("return/*@cc_on!@*/!1")()) &&
        /MSIE\s*(\d+\.?\d*)/i.test(d)
      ...
      if (this.isIE)
        for (
          c =
            "Msxml2.XMLHTTP Msxml2.DOMDocument Microsoft.XMLDOM ShockwaveFlash.ShockwaveFlash TDCCtl.TDCCtl Shell.UIHelper Scripting.Dictionary wmplayer.ocx".split(
              " "
            ),
            b = 0;
          b < c.length;
      ...
      this.verGecko = (this.isGecko =
        /Gecko/i.test(a) && /Gecko\s*\/\s*\d/i.test(d))
        ? this.formatNum(/rv\s*\:\s*([\.\,\d]+)/i.test(d) ? RegExp.$1 : "0.9")
        : null;
      this.verChrome = (this.isChrome = /Chrome\s*\/\s*(\d[\d\.]*)/i.test(d))
        ? this.formatNum(RegExp.$1)
        : null;
      this.verSafari =
        (this.isSafari =
          (/Apple/i.test(e) || (!e && !this.isChrome)) &&
          /Safari\s*\/\s*(\d[\d\.]*)/i.test(d)) &&
        /Version\s*\/\s*(\d[\d\.]*)/i.test(d)
          ? this.formatNum(RegExp.$1)
          : null;
      this.verOpera =
        (this.isOpera = /Opera\s*[\/]?\s*(\d+\.?\d*)/i.test(d)) &&
        (/Version\s*\/\s*(\d+\.?\d*)/i.test(d), 1)
          ? parseFloat(RegExp.$1, 10)
          : null;
    ...
    fPush: function (a, b) {
      this.isArray(b) &&
        (this.isFunc(a) ||
          (this.isArray(a) && 0 < a.length && this.isFunc(a[0]))) &&
        b.push(a);
    },
    ...
    $$getVersion: function (a) {
      return function (b, c, d) {
        ...
        a.cleanup();
        return (c = (c = b.version || b.version0)
          ? c.replace(a.splitNumRegx, a.getVersionDelimiter)
          : c);
      };
    },
    cleanup: function () {
    ...
    codebaseSearch: function (a, b) {
      ...
      a.BIfuncs &&
        a.BIfuncs.length &&
        null !== a.BIfuncs[a.BIfuncs.length - 1] &&
        c.callArray(a.BIfuncs);
      var d,
        e = a.SEARCH;
      if (c.isStrNum(b)) {
        if (e.match && e.min && 0 >= c.compareNums(b, e.min)) return !0;
        if (e.match && e.max && 0 <= c.compareNums(b, e.max)) return !1;
        (d = c.isActiveXObject(a, b)) &&
          (!e.min || 0 < c.compareNums(b, e.min)) &&
          (e.min = b);
    ...
    onDoneEmptyDiv: function () {
      ...
      if (
        ...
        (!this.WLfuncs ||
          !this.WLfuncs.length ||
          null === this.WLfuncs[this.WLfuncs.length - 1])
      ) {
        for (a in this)
          if (
            (b = this[a]) &&
            b.funcs &&
            (3 == b.OTF ||
              (b.funcs.length && null !== b.funcs[b.funcs.length - 1]))
          )
            return;
    ...
    getWidth: function (a) {
      return a && ((a = a.scrollWidth || a.offsetWidth), this.isNum(a))
        ? a
        : -1;
    },
    getTagStatus: function (a, b, c, d) {
      ...
      try {
        if (
          f == this.pluginSize &&
          (!this.isIE || 4 == this.getDOMobj(a).readyState) &&
          ((!a.winLoaded && this.winLoaded) ||
            (a.winLoaded &&
              this.isNum(d) &&
              (this.isNum(a.count) || (a.count = d), 10 <= d - a.count)))
        )
          return 1;
      } catch (k) {}
      return 0;
    ...
    insertHTML: function (a, b, c, d, e) {
      ...
      if (this.isString(a) && /[^\s]/.test(a)) {
        ...
        var k =
          ...
          '" ';
        k +=
          'style="outline-style:none;border-style:none;padding:0px;margin:0px;visibility:visible;display:inline;" ';
      ...
      this.div ||
        ((b = e.getElementById(this.divID))
          ? (this.div = b)
          : ((this.div = e.createElement("div")), (this.div.id = this.divID)),
        this.setStyle(
          this.div,
          l.concat([
            "width",
        ...
        b ||
          (this.setStyle(
            this.div,
            "position absolute right 0px top 0px".split(" ")
          ),
      ...
      quicktime: {
        ...
        getVersion: function (a) {
          ...
          if (b.isIE) {
            ...
            !c &&
              b.verIE >= this.minIEver &&
              (c = this.CDBASE2VER(b.codebaseSearch(this)));
            c ||
              ((d = b.getAXO(this.progID)) &&
                d.QuickTimeVersion &&
                ((c = d.QuickTimeVersion.toString(16)),
                (c =
                  parseInt(c.charAt(0), 16) +
                  "." +
                  parseInt(c.charAt(1), 16) +
                  "." +
                  parseInt(c.charAt(2), 16))));
          } else
            b.hasMimeType(this.mimeType) &&
              (d =
                3 != b.OS ? b.findNavPlugin("QuickTime.*Plug-?in", 0) : null) &&
              d.name &&
              (c = b.getNum(d.name));
        ...
        CDBASE2VER: function (a) {
          ...
          if (a)
            for (a = b.formatNum(a), c = 0; c < d.length; c++)
              if (
                d[c] &&
                0 > b.compareNums(a, d[c]) &&
                e[c] &&
                0 <= b.compareNums(a, e[c]) &&
                this.cdbase2ver[c]
              )
        ...
        getVersion: function () {
          ...
          if (b.isIE) {
            ...
            if ((e = b.hasMimeType(this.mimeType))) {
              c = b.getDOMobj(
                b.insertHTML("object", ["type", this.mimeType], [], "", this)
              );
              try {
      ...
      shockwave: {
        ...
        getVersion: function () {
          ...
          if (c.isIE) {
            ...
            c.isString(b) && 0 < b.length
              ? (a = c.getNum(b))
              : c.getAXO(this.progID + ".8")
              ? (a = "8")
              : c.getAXO(this.progID + ".7")
              ? (a = "7")
              : c.getAXO(this.progID + ".1") && (a = "6");
          } else
            (b = c.findNavPlugin("Shockwave\\s*for\\s*Director")) &&
              b.description &&
              c.hasMimeType(this.mimeType) &&
              (a = c.getNum(b.description)),
  ...
  (function () {
    ...
    g.fn.iLightBoxHashChange = function (a) {
      return a
        ? this.bind("iLightBoxHashChange", a)
        : this.trigger("iLightBoxHashChange");
    };
    ...
    var f = (function () {
      function c() {
        var b = a(),
          d = t(n);
        b !== n
          ? (r((n = b), d), g(p).trigger("iLightBoxHashChange"))
...
!(function (e, n, t) {
  for (
    var i,
      ...
      o = 0,
      u = r.length;
    o < u && !n.requestAnimationFrame;
    ++o
  )
    (n.requestAnimationFrame = n[r[o] + "RequestAnimationFrame"]),
      (n.cancelAnimationFrame =
        n[r[o] + "CancelAnimationFrame"] ||
        n[r[o] + "CancelRequestAnimationFrame"]);
