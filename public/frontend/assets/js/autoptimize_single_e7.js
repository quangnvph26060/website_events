(function ($) {
  ...
  kleanity_sf_menu.prototype = {
    ...
    sf_menu_position: function () {
      ...
      var sub_normal_menu = this.main_menu.find(
        ".sf-menu > li.kleanity-normal-menu .sub-menu"
      );
      ...
      this.main_menu
        .find(".sf-menu > li.kleanity-mega-menu .sf-mega")
        .each(function () {
    ...
    init_slidebar: function () {
        ...
        .hover(
          function () {
            ...
            if (nav_element.length > 0) {
              t.slide_bar.animate(
                { left: nav_element.position().left },
      ...
      $(window).on("kleanity-navigation-slider-bar-animate", function () {
        t.animate_slidebar_pos();
      });
    },
  ...
  $.fn.kleanity_mobile_menu = function (args) {
    ...
    $(this)
      ...
      .each(function () {
        ...
        $('<span class="kleanity-mm-menu-blank" ></span>')
          .html(content)
          .insertBefore($(this));
        $(this).remove();
      });
  ...
  kleanity_header_side_nav.prototype = {
    ...
    init_nav_bar_element: function () {
      ...
      var middle_pos = t.side_nav_content
        .children(".kleanity-pos-middle")
        .addClass("kleanity-active");
      var bottom_pos = t.side_nav_content
        .children(".kleanity-pos-bottom")
        .addClass("kleanity-active");
      ...
      if ($(window).height() < t.side_nav_content.height()) {
        ...
        t.side_nav
          .removeClass(
            "kleanity-allow-slide kleanity-fix-top kleanity-fix-bottom"
          )
          .css("top", "");
        if (t.side_nav.hasClass("kleanity-style-middle")) {
          middle_pos.each(function () {
            ...
            var prespace =
              ...
              top_padding;
            if (prespace > 0) {
              $('<div class="kleanity-pre-spaces" ></div>')
                .css("height", prespace)
                .insertBefore($(this));
            }
          });
  ...
  var kleanity_anchor = function () {
    this.anchor_link = $('a[href^="#"]')
      ...
      .filter(function () {
        if (
          $(this).is(
            ".kleanity-mm-menu-button, .mm-next, .mm-prev, .mm-title, .gdlr-core-ilightbox"
          )
        ) {
          return false;
        }
        ...
        if (
          ...
          $(this).not('[class^="kleanity"]').closest(".woocommerce").length
        ) {
          return false;
        }
        return true;
    ...
    if (this.anchor_link.length) {
      ...
      this.home_anchor = this.menu_anchor.find(
        "ul.sf-menu > li.current-menu-item > a, ul.sf-menu > li.current-menu-ancestor > a, .kleanity-bullet-anchor-link.current-menu-item"
      );
      this.init();
    }
  };
    ...
    scroll_to: function (hash, redirect, duration) {
      ...
      if (typeof scroll_position != "undefined") {
        ...
        if (typeof window.kleanity_anchor_offset != "undefined") {
          scroll_position =
            scroll_position - parseInt(window.kleanity_anchor_offset);
        }
        ...
        if (
          ...
          t.home_anchor.each(function () {
            if ($(this).hasClass("kleanity-bullet-anchor-link")) {
              ...
              $(this)
                .parent(".kleanity-bullet-anchor")
                .attr("data-anchor-section", "kleanity-home");
            } else if (
  ...
  var kleanity_sticky_navigation = function () {
    this.sticky_nav = $(
      ".kleanity-with-sticky-navigation .kleanity-sticky-navigation"
    );
  ...
  kleanity_sticky_navigation.prototype = {
    ...
    style_fixed: function () {
      var t = this;
      var placeholder = $(
        '<div class="kleanity-sticky-menu-placeholder" ></div>'
      );
      $(window).on("scroll kleanity-set-sticky-navigation", function () {
        ...
        if (!t.sticky_nav.hasClass("kleanity-fixed-navigation")) {
          if ($(window).scrollTop() + page_offset > t.sticky_nav.offset().top) {
            ...
            if (logo_padding > 0) {
              t.sticky_nav_logo.css({
                "padding-top": logo_padding,
                "padding-bottom": logo_padding,
              });
            } else {
              t.sticky_nav_logo.css({
                height: t.sticky_nav_logo.height(),
                width: "auto",
              });
              t.sticky_nav.addClass("kleanity-animate-logo-height");
            }
            setTimeout(function () {
              t.sticky_nav.addClass("kleanity-animate-fixed-navigation");
            }, 10);
            setTimeout(function () {
          ...
          if ($(window).scrollTop() + page_offset <= placeholder.offset().top) {
            ...
            setTimeout(function () {
              t.sticky_nav.removeClass(
                "kleanity-animate-fixed-navigation kleanity-animate-logo-height"
              );
            }, 10);
            setTimeout(function () {
              t.sticky_nav.css("height", "");
        ...
        if (!t.sticky_nav.hasClass("kleanity-fixed-navigation")) {
          if (
            ...
            t.sticky_nav.addClass(
              "kleanity-fixed-navigation kleanity-animate-fixed-navigation"
            );
    ...
    style_mobile_slide: function () {
      var t = this;
      var placeholder = $(
        '<div class="kleanity-sticky-mobile-placeholder" ></div>'
      );
  ...
  $(document).ready(function () {
    ...
    $("#kleanity-main-menu, #kleanity-right-menu, #kleanity-mobile-menu").each(
      function () {
    ...
    $(
      ".kleanity-header-boxed-wrap, .kleanity-header-background-transparent, .kleanity-navigation-bar-wrap.kleanity-style-transparent"
    ).each(function () {
    ...
    $("body.error404, body.search-no-results").each(function () {
      ...
      var body_wrap_offset = parseInt(
        $(this)
          .children(".kleanity-body-outer-wrapper")
          .children(".kleanity-body-wrapper")
          .css("margin-bottom")
      );
      var padding =
        ($(window).height() -
    ...
    $("body")
      .children("#kleanity-page-preload")
      .each(function () {
        var page_preload = $(this);
        var animation_time = parseInt(page_preload.attr("data-animation-time"));
        $("a[href]")
          .not(
            '[href^="#"], [target="_blank"], .gdlr-core-js, .strip, a[href$=".jpg"], a[href$=".png"], a[href$=".gif"]'
          )
          .click(function (e) {
  ...
  $(window).load(function () {
    $("#kleanity-fixed-footer").each(function () {
      ...
      var placeholder = $(
        '<div class="kleanity-fixed-footer-placeholder" ></div>'
      );
